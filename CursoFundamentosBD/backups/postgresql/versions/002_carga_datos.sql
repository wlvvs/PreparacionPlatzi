...
ALTER TABLE ct_nationalities RENAME COLUMN dsnacionalidad TO dsnationality;
...
insert into ct_bands (dsbanda, fcfechacreacion, boestatus, llnationality) values ('Jeff Buckley','1990-02-01', 'false', 1);
insert into ct_bands (dsbanda, fcfechacreacion, boestatus, llnationality) values ('Nirvana','1987-04-12', 'false', 1);
...
insert into ct_bandmembers (dsnombre, dsapellido1, dsapellido2, dsaka, fcfechanacimiento, boestatus, llnationality) values ('Jeff','Scott','Buckley','Scott Moorhead','1966-11-17', 'false', 1);
insert into ct_bandmembers (dsnombre, dsapellido1, dsapellido2, dsaka, fcfechanacimiento, boestatus, llnationality) values ('Karl','Hans','Berger',NULL,'1935-03-30', 'false', 2);
insert into ct_bandmembers (dsnombre, dsapellido1, dsapellido2, dsaka, fcfechanacimiento, boestatus, llnationality) values ('Mick','Grondahl',NULL,NULL,'1968-05-07', 'false', 3);
insert into ct_bandmembers (dsnombre, dsapellido1, dsapellido2, dsaka, fcfechanacimiento, boestatus, llnationality) values ('Michael','Oliver','Tighe',NULL,'1969-04-15', 'false', 1);
insert into ct_bandmembers (dsnombre, dsapellido1, dsapellido2, dsaka, fcfechanacimiento, boestatus, llnationality) values ('Andy','Wallace',NULL,NULL,'1947-07-25', 'false', 1);
insert into ct_bandmembers (dsnombre, dsapellido1, dsapellido2, dsaka, fcfechanacimiento, boestatus, llnationality) values ('Kurt','Donald','Cobain',NULL,'1967-02-20', 'false', 1);
insert into ct_bandmembers (dsnombre, dsapellido1, dsapellido2, dsaka, fcfechanacimiento, boestatus, llnationality) values ('Krist','Anthony','Novoselic',NULL,'1965-05-16', 'false', 1);
insert into ct_bandmembers (dsnombre, dsapellido1, dsapellido2, dsaka, fcfechanacimiento, boestatus, llnationality) values ('David','Eric','Grohl','Late!','1969-01-14', 'false', 1);
insert into ct_bandmembers (dsnombre, dsapellido1, dsapellido2, dsaka, fcfechanacimiento, boestatus, llnationality) values ('Bryan','David','Vig','Butch','1955-08-02', 'false', 1);
insert into ct_bandmembers (dsnombre, dsapellido1, dsapellido2, dsaka, fcfechanacimiento, boestatus, llnationality) values ('Daniel','Quine','Auerbach',NULL,'1979-05-14', 'true', 1);
insert into ct_bandmembers (dsnombre, dsapellido1, dsapellido2, dsaka, fcfechanacimiento, boestatus, llnationality) values ('Patrick','James','Cartney',NULL,'1980-04-15', 'true', 1);
...
insert into crc_bands_bandmembers (llband, llbandmember, fcfechainicio, fcfechafin, boestatus) values (1,1,'1990-02-01','1997-05-29', 'false');
insert into crc_bands_bandmembers (llband, llbandmember, fcfechainicio, fcfechafin, boestatus) values (1,2,'1993-12-01','1994-08-23', 'false');
insert into crc_bands_bandmembers (llband, llbandmember, fcfechainicio, fcfechafin, boestatus) values (1,3,'1990-02-01','1997-05-29', 'false');
insert into crc_bands_bandmembers (llband, llbandmember, fcfechainicio, fcfechafin, boestatus) values (1,4,'1993-12-01','1994-08-23', 'false');
insert into crc_bands_bandmembers (llband, llbandmember, fcfechainicio, fcfechafin, boestatus) values (1,5,'1993-12-01','1994-08-23', 'false');
insert into crc_bands_bandmembers (llband, llbandmember, fcfechainicio, fcfechafin, boestatus) values (2,6,'1987-03-15','1994-04-05', 'false');
insert into crc_bands_bandmembers (llband, llbandmember, fcfechainicio, fcfechafin, boestatus) values (2,7,'1987-03-15','1994-04-05', 'false');
insert into crc_bands_bandmembers (llband, llbandmember, fcfechainicio, fcfechafin, boestatus) values (2,8,'1987-03-15','1994-04-05', 'false');
insert into crc_bands_bandmembers (llband, llbandmember, fcfechainicio, fcfechafin, boestatus) values (2,9,'1990-04-10','1991-09-24', 'false');
insert into crc_bands_bandmembers (llband, llbandmember, fcfechainicio, fcfechafin, boestatus) values (2,5,'1990-04-10','1991-09-24', 'false');
insert into crc_bands_bandmembers (llband, llbandmember, fcfechainicio, fcfechafin, boestatus) values (3,10,'2001-12-21',NULL, 'true');
insert into crc_bands_bandmembers (llband, llbandmember, fcfechainicio, fcfechafin, boestatus) values (3,11,'2001-12-21',NULL, 'true');
